...
# Does your code still work? It should, but you may notice
...
# is a reasonable lower bound for this payment value?
...
# we didn't pay off each month. So a good upper bound
